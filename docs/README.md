...
- [`maintainer/VALIDATION-POLICY-CONTRACT.md`](maintainer/VALIDATION-POLICY-CONTRACT.md) — canonical phase-2 validation-policy authority note covering the official bundle taxonomy, four-level model, changed-surface selection, explicit local-vs-GitHub exceptions, and later derivative migrations.
