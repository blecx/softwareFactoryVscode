...
| [`PRODUCTION-READINESS-PLAN.md`](PRODUCTION-READINESS-PLAN.md)                                                       | Active supporting plan | Current readiness sequencing within the shipped `2.8` guardrails and the scope defined by `PRODUCTION-READINESS.md`. |
