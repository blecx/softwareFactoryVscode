...
- That's it! 
- *Magic*: Upon opening the folder, VS Code will automatically start the background task: `Docker: Build & Start`. It runs in the foreground of a hidden background-terminal. 
