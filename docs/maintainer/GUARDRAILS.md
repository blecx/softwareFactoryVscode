...
| Host-owned wiki truth contract and projection ownership | [`HOST-WIKI-TRUTH-CONTRACT.md`](HOST-WIKI-TRUTH-CONTRACT.md), [`../WIKI-MAP.md`](../WIKI-MAP.md), [`../../manifests/wiki-projection-manifest.json`](../../manifests/wiki-projection-manifest.json), canonical `../*.md` docs | Which host-owned files define publication policy, projection config, canonical content, and why `.copilot` must stay reusable procedure only | You are onboarding a future host repo to the wiki workflow stack or deciding whether a wiki-related change belongs in host docs vs reusable procedure |
...
- **Future-project wiki ownership split:** start with `docs/maintainer/HOST-WIKI-TRUTH-CONTRACT.md`, `docs/WIKI-MAP.md`, and `manifests/wiki-projection-manifest.json`.
