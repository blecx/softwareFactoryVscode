...
*   **Do not require approvals (Optional but Recommended for Autonomous AI):** If you want the AI to be able to merge its own PRs after CI passes, set the required human approvals to `0`. If you want a human in the loop, set this to `1`.
