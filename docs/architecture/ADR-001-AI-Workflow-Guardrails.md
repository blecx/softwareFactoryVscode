...
- **Rule:** If a user provides an unformatted prompt, unstructured text issue, or incomplete Pull Request, the Agent's _first_ action must be to reject the request and ask the user to format it using the required template.
