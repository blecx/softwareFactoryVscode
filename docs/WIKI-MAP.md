...
| Composite tutorial/index projection assembled from [`docs/INSTALL.md`](INSTALL.md), [`docs/HANDOUT.md`](HANDOUT.md), and [`docs/CHEAT_SHEET.md`](CHEAT_SHEET.md) | `Tutorials` | Evaluators / operators | Wiki-native landing page for scenario-driven learning paths built only from already wiki-safe operator sources. |
| Composite tutorial projection assembled from [`docs/INSTALL.md`](INSTALL.md) and [`docs/HANDOUT.md`](HANDOUT.md) | `Install a New Project` | New operators | Step-by-step walkthrough for creating a fresh repo install and opening the generated workspace without introducing maintainer-only setup steps. |
...
| Composite scenario projection assembled from [`docs/HANDOUT.md`](HANDOUT.md), [`docs/INSTALL.md`](INSTALL.md), and [`docs/CHEAT_SHEET.md`](CHEAT_SHEET.md) | `Examples` | Evaluators / operators | Scenario-style link clusters derived from current supported workflows rather than new authority or unshipped capabilities. |
| Composite FAQ projection assembled from [`docs/HANDOUT.md`](HANDOUT.md), [`docs/INSTALL.md`](INSTALL.md), and [`docs/CHEAT_SHEET.md`](CHEAT_SHEET.md) | `FAQ` | Evaluators / operators | High-signal Q&A distilled from supported operator behavior and terminology already present in the canonical docs. |
