...
```chatagent
---
description: "Executes the repeatable backend issue queue to PR to merge loop using canonical Copilot agents."
---
...
- Use this when the operator wants the canonical backend queue issue → PR → merge loop in Copilot.
